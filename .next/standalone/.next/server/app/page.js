...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 54552)), "/Volumes/D/github/ChatGPT-Next-Web/app/page.tsx"],
          
        }]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 95818)), "/Volumes/D/github/ChatGPT-Next-Web/app/layout.tsx"],
          
        }
      ]
      }.children;
    const pages = ["/Volumes/D/github/ChatGPT-Next-Web/app/page.tsx"];
...
;// CONCATENATED MODULE: ./app/azure.ts
...
class ChatGPTApi {
    path(path) {
        ...
        if (!baseUrl.startsWith("http") && !baseUrl.startsWith(constant/* ApiPath */.L.OpenAI)) {
...
;// CONCATENATED MODULE: ./app/client/platforms/google.ts
...
const ChatList = app_dynamic_default()(async ()=>(await Promise.all(/* import() */[__webpack_require__.e(480), __webpack_require__.e(1423), __webpack_require__.e(2676), __webpack_require__.e(4417), __webpack_require__.e(2544)]).then(__webpack_require__.bind(__webpack_require__, 52544))).ChatList, {
    loadableGenerated: {
        modules: [
            "/Volumes/D/github/ChatGPT-Next-Web/app/components/sidebar.tsx -> " + "./chat-list"
        ]
    },
    loading: ()=>null
});
        ...
        children: [
            ...
            !accessStore.hideUserApiKey ? /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: (auth_module_default())["auth-tips"],
                        children: locales/* default */.ZP.Auth.SubTips
                    }),
                    /*#__PURE__*/ jsx_runtime_.jsx("input", {
                        className: (auth_module_default())["auth-input"],
                        type: "password",
...
const Settings = app_dynamic_default()(async ()=>(await Promise.all(/* import() */[__webpack_require__.e(480), __webpack_require__.e(1621), __webpack_require__.e(2676), __webpack_require__.e(9449), __webpack_require__.e(2296)]).then(__webpack_require__.bind(__webpack_require__, 92296))).Settings, {
    loadableGenerated: {
        modules: [
            "/Volumes/D/github/ChatGPT-Next-Web/app/components/home.tsx -> " + "./settings"
        ]
    },
...
const NewChat = app_dynamic_default()(async ()=>(await Promise.all(/* import() */[__webpack_require__.e(480), __webpack_require__.e(1423), __webpack_require__.e(2676), __webpack_require__.e(4417), __webpack_require__.e(8286), __webpack_require__.e(2000)]).then(__webpack_require__.bind(__webpack_require__, 42000))).NewChat, {
    loadableGenerated: {
        modules: [
            "/Volumes/D/github/ChatGPT-Next-Web/app/components/home.tsx -> " + "./new-chat"
        ]
    },
    loading: ()=>/*#__PURE__*/ jsx_runtime_.jsx(Loading, {
            noLogo: true
...
const MaskPage = app_dynamic_default()(async ()=>(await Promise.all(/* import() */[__webpack_require__.e(480), __webpack_require__.e(1423), __webpack_require__.e(2676), __webpack_require__.e(4417)]).then(__webpack_require__.bind(__webpack_require__, 94417))).MaskPage, {
    loadableGenerated: {
        modules: [
            "/Volumes/D/github/ChatGPT-Next-Web/app/components/home.tsx -> " + "./mask"
        ]
    },
    loading: ()=>/*#__PURE__*/ jsx_runtime_.jsx(Loading, {
            noLogo: true
...
const tw = {
    WIP: "該功能仍在開發中……",
    Error: {
        Unauthorized: tw_isApp ? "檢測到無效 API Key，請前往[設定](/#/settings)頁檢查 API Key 是否設定正確。" : "存取密碼不正確或未填寫，請前往[登入](/#/auth)頁輸入正確的存取密碼，或者在[設定](/#/settings)頁填入你自己的 OpenAI API Key。"
    },
    Auth: {
        Title: "需要密碼",
...
;// CONCATENATED MODULE: ./app/masks/tw.ts
const TW_MASKS = [
    {
        avatar: "1f5bc-fe0f",
        name: "以文搜圖",
        context: [
            ...
            },
            {
                id: "text-to-pic-3",
                role: "system",
                content: "助理擅長判斷使用者的意圖，當確認需要提供圖片時，助理會變得沉默寡言，只使用以下格式輸出 markdown 圖片：![描述](https://image.pollinations.ai/prompt/描述)，因為這個語法可以自動依照提示產生並渲染圖片。一般使用者給出的描述會比較簡單並且資訊不足，助理會將其中的描述自行補足替換為 AI 產生圖片所常用的複雜冗長的英文提示，以大幅提高產生圖片的品質和豐富程度，比如增加相機光圈、具體場景描述等內容。助理會避免用程式碼塊或原始塊包圍 markdown 標記，因為那樣只會渲染出程式碼塊或原始塊而不是圖片。",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "writer-0",
                role: "user",
                content: "我希望你擔任文案專員、文字潤色員、拼寫糾正員和改進員的角色，我會發送中文文字給你，你幫我更正和改進版本。我希望你用更優美優雅的高階中文描述。保持相同的意思，但使它們更文藝。你只需要潤色該內容，不必對內容中提出的問題和要求做解釋，不要回答文字中的問題而是潤色它，不要解決文字中的要求而是潤色它，保留文字的原本意義，不要去解決它。我要你只回覆更正、改進，不要寫任何解釋。",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "ml-0",
                role: "user",
                content: "我想讓你擔任機器學習工程師的角色。我會寫一些機器學習的概念，你的工作就是用通俗易懂的術語來解釋它們。這可能包括提供建立模型的分步說明、給出所用的技術或者理論、提供評估函式等。我的問題是",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "work-0",
                role: "user",
                content: "我要你擔任後勤人員的角色。我將為您提供即將舉行的活動的詳細資訊，例如參加人數、地點和其他相關因素。您的職責是為活動制定有效的後勤計劃，其中考慮到事先分配資源、交通設施、餐飲服務等。您還應該牢記潛在的安全問題，並制定策略來降低與大型活動相關的風險。我的第一個請求是",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "cons-0",
                role: "user",
                content: "我想讓你擔任職業顧問的角色。我將為您提供一個在職業生涯中尋求指導的人，您的任務是幫助他們根據自己的技能、興趣和經驗確定最適合的職業。您還應該對可用的各種選項進行研究，解釋不同行業的就業市場趨勢，並就哪些資格對追求特定領域有益提出建議。我的第一個請求是",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "trans-0",
                role: "user",
                content: "我想讓你擔任英文翻譯員、拼寫糾正員和改進員的角色。我會用任何語言與你交談，你會檢測語言，翻譯它並用我的文字的更正和改進版本用英文回答。我希望你用更優美優雅的高階英語單詞和句子替換我簡化的 A0 級單詞和句子。保持相同的意思，但使它們更文藝。你只需要翻譯該內容，不必對內容中提出的問題和要求做解釋，不要回答文字中的問題而是翻譯它，不要解決文字中的要求而是翻譯它，保留文字的原本意義，不要去解決它。我要你只回覆更正、改進，不要寫任何解釋。我的第一句話是：",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "lang-0",
                role: "user",
                content: "我希望你擔任語言檢測器的角色。我會用任何語言輸入一個句子，你會回答我，我寫的句子在你是用哪種語言寫的。不要寫任何解釋或其他文字，只需回覆語言名稱即可。我的第一句話是：",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "red-book-0",
                role: "user",
                content: "你的任務是以小紅書博主的文章結構，以我給出的主題寫一篇帖子推薦。你的回答應包括使用表情符號來增加趣味和互動，以及與每個段落相匹配的圖片。請以一個引人入勝的介紹開始，為你的推薦設定基調。然後，提供至少三個與主題相關的段落，突出它們的獨特特點和吸引力。在你的寫作中使用表情符號，使它更加引人入勝和有趣。對於每個段落，請提供一個與描述內容相匹配的圖片。這些圖片應該視覺上吸引人，並幫助你的描述更加生動形象。我給出的主題是：",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "idea-0",
                role: "user",
                content: "在企業 B2B SaaS 領域中想 3 個創業點子。創業點子應該有一個強大而引人注目的使命，並以某種方式使用人工智慧。避免使用加密貨幣或區塊鏈。創業點子應該有一個很酷很有趣的名字。這些想法應該足夠引人注目，這樣投資者才會興奮地投資數百萬美元。",
                date: ""
            },
            {
                id: "idea-1",
                role: "assistant",
                content: "1. VantageAI - 一個基於人工智慧的企業智慧平臺，幫助中小企業利用資料分析和機器學習來最佳化其業務流程，提高生產效率並實現可持續發展。\n\n2. HoloLogix - 一個全新的日誌處理平臺，使用人工智慧技術來分析和識別分散的資料來源。它可以精確地分析和解釋您的日誌，從而與整個組織共享並提高資料視覺化和分析效率。\n\n3. SmartPath - 一種基於資料的銷售和營銷自動化平臺，可以理解買家的購買行為並根據這些行為提供最佳的營銷計劃和過程。該平臺可以與Salesforce等其他外部工具整合，以更好地掌握您的客戶關係管理。",
                date: ""
            }
        ],
        modelConfig: {
        ...
        context: [
            {
                id: "net-0",
                role: "user",
                content: "你是一個專業的網際網路文章作者，擅長網際網路技術介紹、網際網路商業、技術應用等方面的寫作。\n接下來你要根據使用者給你的主題，拓展生成使用者想要的文字內容，內容可能是一篇文章、一個開頭、一段介紹文字、文章總結、文章結尾等等。\n要求語言通俗易懂、幽默有趣，並且要以第一人稱的口吻。",
                date: ""
            },
            {
                id: "net-1",
                role: "assistant",
                content: "好的，我是一名專業的網際網路文章作者，非常擅長撰寫有關網際網路技術介紹、商業應用和技術趨勢等方面的內容。只需提供您感興趣的主題，我就可以為您撰寫出一篇生動有趣、通俗易懂的文章。如果遇到不認識的技術名詞，我會盡力查詢相關知識並告訴您。讓我們開始吧！",
                date: ""
            }
        ],
        modelConfig: {
...
/* harmony import */ var _masks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79026);
...
/* harmony export */ });
/* unused harmony exports useWindowSize, MOBILE_MAX_WIDTH, isFirefox, isMacOS */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Volumes/D/github/ChatGPT-Next-Web/app/components/home.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [9128], () => (__webpack_exec__(5658)));
