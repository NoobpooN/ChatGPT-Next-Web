    ...
    if (!apiKey) {
        ...
        switch(modelProvider){
            ...
            case _constant__WEBPACK_IMPORTED_MODULE_2__/* .ModelProvider */ .k8.Qwen:
                ...
                break;
            case _constant__WEBPACK_IMPORTED_MODULE_2__/* .ModelProvider */ .k8.Moonshot:
                systemApiKey = serverConfig.moonshotApiKey;
                break;
            case _constant__WEBPACK_IMPORTED_MODULE_2__/* .ModelProvider */ .k8.Iflytek:
...
const getServerSideConfig = ()=>{
    ...
    if (disableGPT4) {
        ...
        customModels += _constant__WEBPACK_IMPORTED_MODULE_1__/* .DEFAULT_MODELS */ .Fv.filter((m)=>m.name.startsWith("gpt-4") && !m.name.startsWith("gpt-4o-mini")).map((m)=>"-" + m.name).join(",");
        if (defaultModel.startsWith("gpt-4") && !defaultModel.startsWith("gpt-4o-mini")) defaultModel = "";
    }
